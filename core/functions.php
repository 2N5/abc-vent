...
function shortCats($content) {
    $shortcuts = Shortcut::converting();

    foreach ($shortcuts as $shortcut) {
        $content = str_replace($shortcut->title, $shortcut->value, $content);
    }
...
function imgExists($picObj) {
    $class = get_class($picObj);
    $dir = $class::UPLOAD_DIR . $picObj->id . '/' . $picObj->name;
