<div class="col-md-10">
	<a href="<?= $this->printControllerUrl(); ?>" class="btn btn-primary">К списку справок</a>     
	...
	<form method="POST">
		...
		<select name="form[id_category]">
			...
			H1 : <input type="text" name="form[h1]" value="<?= $this->existSingleObject->h1; ?>"></input>
			Саб_тайтл : <input type="text" name="form[sub_title]" value="<?= $this->existSingleObject->sub_title; ?>"></input>
